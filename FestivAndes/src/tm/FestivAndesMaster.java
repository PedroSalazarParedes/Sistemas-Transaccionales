...
public class FestivAndesMaster {
	...
	public void registrarBoletaComprada(Boleta boleta, Integer cliente)throws Exception
	{
		...
		try 
		{
			...
			this.conn = darConexion();
			dao.setConnection(conn);
			dao.registrarBoletaComprada(boleta, cliente, false);
			conn.commit();
	...
	public String consultarFunciones(String criterio) throws Exception {
		...
		try 
		{
			...
			this.conn = darConexion();
			dao.setConnection(conn);
			String s = dao.consultarFunciones(criterio);
			conn.commit();
			return s;
	...
	//RFC2
	public String consultarLugares(Integer idLugar,String criterio) throws Exception {
		ConsultasDAO dao = new ConsultasDAO();
		try 
		{
			//////Transaccion
			this.conn = darConexion();
			dao.setConnection(conn);
			String s = dao.consultarLugares(idLugar,criterio);
			conn.commit();
			return s;
	...
	public String consultarRentabilidad(String compania) throws Exception {
		ConsultasDAO dao = new ConsultasDAO();
		try 
		{
			//////Transaccion
			this.conn = darConexion();
			dao.setConnection(conn);
			String s = dao.consultarRentabilidadCompanias(compania);
			conn.commit();
			return s;
	...
	//RFC3
	public String darReporteDeFuncion(Integer id) throws SQLException, Exception {
		ConsultasDAO dao = new ConsultasDAO();
		try 
		{
			//////Transaccion
			this.conn = darConexion();
			dao.setConnection(conn);
			String s = dao.generarReporteFuncion(id);
			conn.commit();
			return s;
	...
	//RFC4
	public String darReporteDeEspectaculo(Integer id) throws SQLException, Exception {
		ConsultasDAO dao = new ConsultasDAO();
		try 
		{
			//////Transaccion
	...
	public String consultarInfoCompania(Integer id) throws SQLException, Exception
	{
		ConsultasDAO dao = new ConsultasDAO();
		try 
		{
			...
			this.conn = darConexion();
			dao.setConnection(conn);
			String s = dao.consultarCompania(id);
			conn.commit();
			return s;
	...
	public void registrarBoletasCompradas(BoletaMultiple b, int id) throws SQLException, Exception 
	{
		BoletaDAO dao = new BoletaDAO();
		try 
		{
			...
			conn.setAutoCommit(false);
			dao.setConnection(conn);
			dao.registrarBoletasCompradas(b, id);
	...
	public void cancelarFuncion(Long id, int cliente) throws SQLException , Exception
	{
		BoletaDAO dao = new BoletaDAO();
		try 
		{
	...
	public String asistenciasPorCliente(Integer usuario, Integer id) throws SQLException, Exception
	{
		ConsultasDAO dao = new ConsultasDAO();
		try 
		{
			...
			dao.setConnection(conn);
			String s="";
			if(dao.esAdministrador(id))
			{
				s=dao.consultarAsistencia(usuario);
			}
			else if(dao.esCliente(id))
			{
				s=dao.consultarAsistencia(id);
			}
			else
			{
				throw new Exception("El usuario no est� autorizado para hacer esta consulta.");
			}
			conn.commit();
			return s;
	...
	public void registrarAbono(Integer usuario, List<Funcion> funciones, List<Localidad> localidades) throws SQLException, Exception 
	{
		...
		try 
		{
			...
			{
				dao.registrarCompraAbono(funciones.get(i), localidades.get(i), usuario);
			}
	...
	public Devolucion devolverBoleta(BoletaDevolver b, int id) throws SQLException, Exception
	{
		BoletaDAO dao = new BoletaDAO();
		...
		try 
		{
			...
			if(dao.diasParaFuncion(b.getIdfuncion())>=5)
			{
				value=dao.devolverBoleta(b, id, false);
			}
			else
			{
				throw new Exception("Esta operaci�n solo puede realizarse con 5 d�as o mas antes de la funci�n.");
			}
			conn.commit();
	...
	public ListaDevolucion devolverAbono(List<BoletaDevolver> abono, int id) throws SQLException, Exception
	{
		BoletaDAO dao = new BoletaDAO();
		ArrayList<Devolucion> a = new ArrayList<Devolucion>();
		try 
		{
			//////Transacción
			this.conn = darConexion();
			...
			{
				throw new Exception("Esta operaci�n solo puede realizarse 3 semanas antes de que inicie el festival.");
			}
			
			for(BoletaDevolver b : abono)
			{
				Devolucion value=dao.devolverBoleta(b, id, true);
				a.add(value);
			}
			conn.commit();
		...
		ListaDevolucion s = new ListaDevolucion(a);
		return s;
	}
